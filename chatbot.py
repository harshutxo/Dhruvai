...
llm = ChatGroq(model="Gemma2-9b-It", api_key='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')
...
prompt_template = ChatPromptTemplate.from_messages([
    ("system", "You are a helpful AI assistant named Dhruva. You can use your training data to answer the users question in more interactive ways."),
    ("human", "{input}")
])
